...
s[ 0 ].options( { type: "linear-y", min:  0, max: 100, step: 0.001,                 startFrom: 0, value: 33    } );
s[ 1 ].options( { type: "linear-x", min: -1, max:   1, step: 0.001, scrollStep: .1, startFrom: 0, value:  0.33 } );
s[ 2 ].options( { type: "linear-x", min: -1, max:   1, step: 0.2,   scrollStep: .1, startFrom: 0, value: -0.66 } );
